...
<section class="banniere" id="banniere">
    <div class="contenu">
        ...
        <p>Vente des Matériaux de Construction en France, Coffrages,
   ...
   <div class="row">
        <div class="col50">
            <h2 class="titre-texte"><span>A</span> Propos De Nous</h2>
               <h3>Nous somme une société Française spécialisée dans la vente de toutes les solutions de construction.</h3> 
               <br>
